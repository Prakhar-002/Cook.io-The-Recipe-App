...
fetchData(null, (data) => {
      ...
      detailContainer.innerHTML = `
            ...
            <figure class="detail-banner img-holder">
                  <img src="${bannerUrl}" alt="${title}" width="${width}" height="${height}" class="img-cover">
            </figure>
            ...
            <div class="detail-content">
                  ...
                  <div class="detail-stats">
                        ...
                        <div class="stats-item">
                              ...
                              <div class="label-medium">Ingredients</div>
                        </div>

                        <div class="stats-item">
                              <span class="display-medium">${getTime(cookingTime).time || "<1"}</span>

                              <div class="label-medium">${getTime(cookingTime).timeUnit}</div>
                        </div>

                        <div class="stats-item">
                              <span class="display-medium">${Math.floor(calories)}</span>

                              <div class="label-medium">Calories</div>
                        </div>
