...
const initAccordions = function (element) {
...
const /* {Node Element} */ filterTogglers = document.querySelectorAll("[data-filter-toggler]");
...
filterSubmit.addEventListener("click", function () {
      ...
      const /* {NodeLists} */ filterCheckboxes = filterBar.querySelectorAll("input:checked");
...
filterClear.addEventListener("click", function () {
      ...
      const /* {Node Element} */ filterCheckboxes = filterBar.querySelectorAll("input:checked");

      filterCheckboxes?.forEach((elem) => {
            elem.checked = false;
      });
...
const renderRecipes = (data) => {
      ...
      data.hits.map((item, index) => {
            ...
            const /* {NodeList} */ card = document.createElement("div");
